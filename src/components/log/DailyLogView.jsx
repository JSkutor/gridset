...
export default function DailyLogView({ logSummaries, logsByDate, selectedDate, setSelectedDate, monthDate, setMonthDate, exercisesById, sessionsById, routinesById }) {
