...
TODO: a,s 스크롤 되있는 채로 섹션 변경하면 스크롤 유지됨. 초기화 되게 해.

TODO: 달력 날짜 선택된 색 혼동됨.

TODO: S,R,L 개념이 코드 베이스 상 있는지.
S,R,L 개념은 프로젝트 기획단계에서 썼던 용어인데, 지금 코드베이스에 저런 명칭을 쓰는 코드가 있어?
지금은 routine, set, log 페이지로 표시되고, q,w,e로 네비게이션함.
-> yes
